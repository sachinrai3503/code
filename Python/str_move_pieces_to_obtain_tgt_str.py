...
# SAME AS - https://leetcode.com/problems/swap-adjacent-in-lr-string/
    ...
    def canChange(self, start: str, target: str) -> bool:
        ...
        for j in range(t_len):
            if target[j]=='_': continue
                ...
                while i<s_len and start[i]=='_': i+=1
                if i==s_len or start[i]=='R': return False
                elif i<j: return False # L but to the left
                else: i+=1
            else:
                while i<s_len and start[i]=='_': i+=1
                if i==s_len or start[i]=='L': return False
                elif i>j: return False # R but to the right
                else: i+=1
        while i<s_len:
