...
public class Distinct_Palin_substr {
    ...
    void print_all_distinct_palin_substr(String str){
        ...
        System.out.println("Number of distinct palindrom substr = "+set.size());
    ...
    public static void main(String[] args) {
        ...
        Distinct_Palin_substr distinct_Palin_substr = new Distinct_Palin_substr();
